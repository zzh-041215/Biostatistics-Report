...
% -------------------------------------------------------------------
\begin{frame}{Task 3: Type-I Error \& ROC Analysis}{Calibration and power–Type-I trade-off}
\vspace{0.10cm}
\begin{columns}[T,totalwidth=\linewidth]
\begin{column}{0.32\linewidth}
  \centering
  {\normalsize\bfseries Type-I Error}\\[0.12em]
  \tiny
  \begin{tabular}{lccc}
  \toprule
  Family & $r=3$ & $r=5$ & $r=10$ \\
...
\begin{column}{0.36\linewidth}
  \centering
  \fig[width=\linewidth,height=0.52\textheight,keepaspectratio]{mmmd_roc_curves.png}
\end{column}
\begin{column}{0.32\linewidth}
  \centering
  {\normalsize\bfseries ROC Scan}\\[0.12em]
  \tiny
  \begin{tabular}{lcc}
  \toprule
  Family & FPR & TPR \\
